...
function loadLocalStorageStep8() {
  if (localStorage.getItem("listSpace8") !== null) {
    ...
    if (data.membership) {
      $(`input[name="membership"][value="${data.membership}"]`).prop(
        "checked",
        true
      );
    }
  ...
  const newDeskFields = `
        <div class="row desk-fields align-items-center mb-2">
            ...
            <div class="col-auto ms-auto">
                <input type="checkbox" class="form-check-input" id="deskCheckbox" ${
                  isChecked ? "checked" : ""
                }/>
...
function addMeetingField(
  ...
  const newMeetingFields = `
        <div class="row meeting-fields align-items-center mb-2">
            ...
            <div class="col-auto ms-auto">
                <input type="checkbox" class="form-check-input" id="meetingCheckbox" ${
                  isChecked ? "checked" : ""
                }/>
