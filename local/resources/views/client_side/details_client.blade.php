        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if ($desk_pricing->isEmpty() && $meeting_pricing->isEmpty())
                            <p>No pricing information available.</p>
                        @else
                            @if ($desk_pricing->isNotEmpty())
                            ...
                            @if ($meeting_pricing->isNotEmpty())
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($meeting_pricing as $price)
                                                <tr>
                                                    <td>
                                                        {{ $price['hours'] }}
                                                    </td>
                            ...
                            <form method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="hours" name="hours" required>
                                        @if ($desk_pricing->isEmpty() && $meeting_pricing->isEmpty())
                                            <option selected disabled>No pricing information available</option>
                                        @endif
                                        @if ($desk_pricing->isNotEmpty())
                                            <option disabled>Select Desk Hours</option>
                                            @foreach ($desk_pricing as $price)
                                                <option value="desk,{{ $price->id }}">{{ $price->duration }}</option>
                                            @endforeach
                                        @endif
                                        @if ($meeting_pricing->isNotEmpty())
                                            <option disabled>Select Meeting Hours</option>
                                            @foreach ($meeting_pricing as $price)
                                                <option value="meeting,{{ $price->id }}">{{ $price->hours }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                @if ($desk_pricing->isEmpty() && $meeting_pricing->isEmpty())
                                    <button disabled type="submit" class="btn btn-secondary">No available price</button>
                                @else
