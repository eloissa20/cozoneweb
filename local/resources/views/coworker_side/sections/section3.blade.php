<div class="form-section" id="step3">
    ...
    <form id="section3">
                    ...
                    <div class="basic-container">
                        ...
                        <div class="row">
                            <div class="col-auto form-check">
                                <input class="form-check-input" type="checkbox" name="basics" value="Wifi" id="wifi" />
        ...
        <div class="d-flex justify-content-end mt-4">
            <button type="button" class="btn btn-light" id="prevButton3">Previous</button>
            <button type="button" class="btn btn-dark ms-3" id="nextButton3">Next</button>
        </div>         
    </form>
</div>